...
router.post('/', validateCreateProject, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var project, error_1;
...
router.put('/:id', validateUpdateProject, function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var id, project, updated, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, prisma.project.delete({ where: { id: id } })];
            case 2:
                _a.sent();
